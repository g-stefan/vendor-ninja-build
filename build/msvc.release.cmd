...
echo -^> release vendor-ninja-build
...
xyo-cc ninja-build --has-archived-release --version-file=version.ini
...
call :cmdX xyo-cc ninja-build --archive-release-sha512 --version-file=version.ini
